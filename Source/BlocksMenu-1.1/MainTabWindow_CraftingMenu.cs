...
namespace BlocksMenu
{
    ...
    public class MainTabWindow_CraftingMenu : MainTabWindow
    {
        ...
        {
            GeneralUI.CheckboxMinimal(rect, !showProducedThingName ? "List Item Names" : "List Bill Names", Color.gray, ref showProducedThingName);
        }
        ...
        public void DoItemDescription(Rect rect)
        {
            ...
            Widgets.InfoCardButton(rectInfo.x, rectInfo.y, selectedDef);
